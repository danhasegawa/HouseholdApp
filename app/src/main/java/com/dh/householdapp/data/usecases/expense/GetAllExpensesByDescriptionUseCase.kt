...
class GetAllExpensesByDescriptionUseCase @Inject constructor(private val expenseRepository: ExpenseRepository) {

    operator fun invoke() : Flow<List<Expense>>{
        return expenseRepository.getExpenseByDescription()
    }
}